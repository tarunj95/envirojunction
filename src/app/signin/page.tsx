    ...
    <Box sx={{
      ...
      >
        ...
        <Typography variant="body1" sx={{ color: '#666', mb: 4, fontSize: '0.9rem' }}>
          To create an account, kindly share the necessary details.
        </Typography>
        ...
        <form onSubmit={formik.handleSubmit}>
          <Stack spacing={3}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <FormControlLabel
                control={<Checkbox size="small" sx={{
                  color: '#ccc',
                  '&.Mui-checked': { color: '#1e6b52' }
                }} />}
                label={<Typography sx={{ fontSize: '0.85rem', color: '#666' }}>Remember me</Typography>}
              />
              <Link href="/forgot-password" style={{ textDecoration: 'none' }}>
                <Typography sx={{ fontSize: '0.85rem', color: '#1e6b52', fontWeight: 500, '&:hover': { textDecoration: 'underline' } }}>
                  Forgot Password?
                </Typography>
              </Link>
            </Box>
            ...
            <Typography variant="body2" align="center" sx={{ color: '#666', mt: 2 }}>
              ...
              <Link href="/signup" style={{ color: '#1e6b52', fontWeight: 600, textDecoration: 'none' }}>
                Sign up
              </Link>
            </Typography>
          </Stack>
